...
![Підтвердження розв'язаних задач](LeetCode_problems.png)

---

## Висновок
Цей блок допоміг закріпити розуміння того, як працюють масиви «під капотом». Тепер я краще розумію складність операцій і можу ефективніше підбирати структури даних для оптимізації швидкодії коду.